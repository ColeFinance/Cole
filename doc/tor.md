...
versions of Tor see [Section 3](#3-automatically-listen-on-tor).*
	...
	HiddenServicePort 8855 127.0.0.1:8855
	HiddenServicePort 18855 127.0.0.1:18855

The directory can be different of course, but (both) port numbers should be equal to
your bitcoind's P2P listen port (8855 by default).
...
and open port 8855 on your firewall (or use -upnp).
